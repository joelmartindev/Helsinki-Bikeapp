...
const JourneyTable = () => {
  ...
  const journeysMap = journeys.map((journey) => {
    return (
      ...
      >
        <td className="grid grid-cols-2 px-3 py-2 before:content-['Departure_station:_\00a0'] sm:table-cell sm:py-5 sm:before:content-none">
          <div className="text-left sm:text-center">
            {journey.departure_station}
          </div>
        </td>
        <td className="grid grid-cols-2 px-3 py-2 before:content-['Return_station:_\00a0'] sm:table-cell sm:py-5 sm:before:content-none">
          <div className="text-left sm:text-center">
            {journey.return_station}
          </div>
        </td>
        <td className="grid grid-cols-2 px-3 py-2 before:content-['Covered_distance:_\00a0'] sm:table-cell sm:py-5 sm:before:content-none">
          <div className="text-left sm:text-center">
            {journey.covered_distance}
          </div>
        </td>
        <td className="grid grid-cols-2 px-3 py-2 pb-6 before:content-['Duration:_\00a0'] sm:table-cell sm:py-5 sm:before:content-none">
